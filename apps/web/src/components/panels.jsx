  ...
  return (
    <section className="panel" aria-label="Portfolio">
      <div className="panel-head">
        ...
        <span className="panel-sub">4 positions</span>
      </div>
      ...
      <div className="panel-body">
        <div>
          ...
          <div
            className="pf-sub"
            style={{ color: "var(--color-cyan-ink)" }}
          >
  ...
  return (
    <section className="panel" aria-label="Scanner">
      <div className="panel-head">
        ...
        <span className="panel-sub">6 signals</span>
      </div>
      ...
      <div className="panel-body">
        ...
        {(full ? WATCH : WATCH.slice(0, 4)).map((w) => (
          <SecondaryCard
            key={w.ticker}
            {...w}
          />
  ...
  return (
    <section className="panel" aria-label="Watchlist">
      <div className="panel-head">
        ...
        <span className="panel-sub">{WATCHLIST.length}</span>
      </div>
      ...
      >
        {WATCHLIST.map((w) => {
          ...
          const spark =
            (L && L.spark) ||
            (w.gold
              ? [20, 22, 21, 23, 24, 23, 25]
              : up
                ? [20, 22, 21, 24, 26, 25, 28]
                : [28, 27, 29, 26, 25, 24, 23]);

          return (
            <button
              className="wl-row"
              key={w.ticker}
              onClick={() => ui?.openTicker(w.ticker)}
              aria-label={`${w.ticker}, ${
                up ? "up" : "down"
...
export function ChartPanel() {
  ...
  const history =
    useMarketHistory(ticker, timeframe);
